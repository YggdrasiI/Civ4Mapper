========================================================================
    KONSOLENANWENDUNG: TakeScreenshot-Projektübersicht
========================================================================

Diese TakeScreenshot-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre TakeScreenshot-Anwendung besteht.


TakeScreenshot.vcxproj
...
TakeScreenshot.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "TakeScreenshot.pch und eine 
